...
<div class="w main">
	...
	<div class="m clearfix" id="bottom_pager">
		<div id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
			...
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2">2</a>
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=3">3</a>
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=4">4</a>
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=5">5</a>
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=6">6</a>
			<span class="text">…</span>
			<a href="search.html?key=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2" class="next">下一页<b></b></a>
		...
		<ul class="list-h clearfix" tpl="2">
			<c:forEach items="${itemList}" var="item">
				<li class="item-book" bookid="11078102">
					...
					<div class="p-price">
						<i>易购价：</i>
						<strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${item.item_price / 100 }"/></strong>
					</div>
